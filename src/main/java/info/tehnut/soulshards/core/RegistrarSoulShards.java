...
public class RegistrarSoulShards {
    ...
    public static final Item CORRUPTED_ESSENCE = new Item(new Item.Settings().group(SoulShards.RE_SoulShards));
    public static final Item CORRUPTED_INGOT = new Item(new Item.Settings().group(SoulShards.RE_SoulShards));
    public static final Item VILE_DUST = new Item(new Item.Settings().group(SoulShards.RE_SoulShards));
    ...
    public static void registerItems(Registry<Item> registry) {
        Registry.register(registry, new Identifier(SoulShards.MODID, "soul_cage"), new BlockItem(SOUL_CAGE, new Item.Settings().group(SoulShards.RE_SoulShards)));
